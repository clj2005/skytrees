...
Page({
  ...
  clickMe: function(event) {
       ...
       var that = this; 
    wx.request({
      url: 'https://www.chengzhangshu9.cn/portal.php?mod=articlestks&json=3&page='+pg, //接口地址
      data: {
  ...
  onLoad: function (options) {
   ...
   // page=options.page;
    ...
    var that = this; 
    wx.request({
      url: 'https://www.chengzhangshu9.cn/portal.php?mod=articlestks&json=3&page='+page, //接口地址
      data: {
